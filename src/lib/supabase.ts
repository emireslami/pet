...
const url = import.meta.env.VITE_SUPABASE_URL || "https://cglqkjfqwxhckjinuhhl.supabase.co";
const key = import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY || "sb_publishable_2eZutl2Jh717yGe_K1g9zw_GLFldR-1";
