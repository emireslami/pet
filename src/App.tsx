...
const nav = [
  ["dashboard", "داشبورد", HomeOutlined], ["pets", "حیوانات", TeamOutlined],
...
function PetMark({ pet, size = 54 }: { pet: Pet; size?: number }) {
  return <div className="pet-mark" style={{ width: size, height: size, background: "linear-gradient(145deg,#557b87,#315f52)", fontSize: size * .4 }}>{pet.name.slice(0, 1)}</div>;
}
